        ...
        <footer>
            <div className={Styles.footerContent}>
                ...
                <div className={Styles.aboutUs}>
                    <div>
                        <img alt="لوگو فروشگاه شهر دیجیتال" />
                        <p>شهر دیجیتال</p>
                    </div>
                    <p>
                        شهر دیجیتال یک فروشگاه اینترنتی با ارائه خدمات در سراسر کشور، اینک در آستانه‌ی آغاز
                ...
                <div className={Styles.contactUs}>
                    ...
                    <Navigation link="tel:09913440342" text="+989027270150" external />
                    <Navigation link="tel:03137763138" text="031 -44113456" external />
